...
if(isset($_GET['act'])) {
	...
	if($_GET['act']=='insert'){
		...
		$askes		= $_POST['askes'];
			...
			if($kode=='' || $nama=='' || $tunjsi=='' || $tunjanak=='' || $uangmakan=='' || $uanglembur=='' || $askes=='') {
				header('location:data_golongan_operator.php?view=tambah&e=bl');
			}else{
				...
				if($simpan){
					header('location:data_golongan_operator.php?e=sukses');
				}else{
					header('location:data_golongan_operator.php?e=gagal');
				}
			}
	}
	elseif($_GET['act']=='update'){
		...
		if($kode=='' || $nama=='' || $tunjsi=='' || $tunjanak=='' || $uangmakan=='' || $uanglembur=='' || $askes==''){
			header('location:data_golongan_operator.php?view=edit&e=bl');
		}else{
			// proses query update
