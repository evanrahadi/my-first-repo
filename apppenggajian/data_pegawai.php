...
<?php
      ...
      <br>		
					...
					<div class="panel-body">
						<a href="data_pegawai.php?view=tambah" class="btn btn-primary" style="margin-bottom: 10px;">Tambah data</a>
				...
				<td>
					...
					<tr>
						...
						<td><input type="submit" class="btn btn-primary" value="simpan">
							<a class="btn btn-danger" href="data_pegawai.php"> kembali</td>
					</tr>
				</table>
			</form>
				...
				<td>
					...
					<tr>
						...
						<td> <input type="number" id="jumlahanak" name="jumlahanak" class="form-control" value="<?php echo $e['jumlah_anak']; ?>" required></td>
								...
								<tr>
									<td></td>
							<td> <input type="submit" value="Update data" class="btn btn-primary"> <a href="data_pegawai.php" class="btn btn-danger">Kembali</td>
								</tr>
							</table>
						</form>
						<script type="text/javascript">
