...
<?php
      ...
      <br>		
					...
					<div class="panel-body">
						<a href="data_jabatan_operator.php?view=tambah" class="btn btn-primary" style="margin-bottom: 10px;">Tambah data</a>
						<table class="table table-bordered table-striped">
							 ...
							 while($d=mysqli_fetch_array($sql)){
							 	...
							 	href='data_jabatan_operator.php?view=edit&id=$d[kode_jabatan]'>Edit</a>
							 	<a class='btn btn-danger btn-sm' href='aksi_jabatan_operator.php?act=del&id=$d[kode_jabatan]'>hapus</a>
							 	</td>
							 	</tr>";
							 	$no++;
							 }
...
<div class="row">
      ...
      <br>
			...
			<div class="panel-body">
				<form method="post" action="aksi_jabatan_operator.php?act=insert">
				<table class="table">
					<tr>
				...
				<td>
					...
					<tr>
						...
						<td><input type="submit" class="btn btn-primary" value="simpan">
							<a class="btn btn-danger" href="data_jabatan_operator.php"> kembali</td>
					</tr>
				</table>
			</form>
		</div>
...
<?php 
	...
	case  "edit":
      ...
      <br>
				...
				<div class="panel-body">
						<form method="post" action="aksi_jabatan_operator.php?act=update">
							<table class="table">
								<tr>
							...
							<td> <input type="number" name="tunjanganjabatan" class="form-control" value="<?php echo $e['tunjangan_jabatan']; ?>" required></td>
								...
								<tr>
									<td></td>
							<td> <input type="submit" value="Update data" class="btn btn-primary"> <a href="data_jabatan_operator.php" class="btn btn-danger">Kembali</td>
								</tr>
							</table>
						</form>
						</div>
