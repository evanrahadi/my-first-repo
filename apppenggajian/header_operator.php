    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index_operator.php">Aplikasi Pengajian</a>
          <p> Halo <b> <?php echo $_SESSION['username']; ?> </b> </p>
        </div>
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="index_operator.php">Home</a></li>
            <li><a href="data_jabatan_operator.php">Data Jabatan</a></li>
            <li><a href="data_golongan_operator.php">Data Golongan</a></li>
            <li><a href="data_pegawai_operator.php">pegawai</a></li>
            <li><a href="data_kehadiran_operator.php">kehadiran pegawai</a></li>
            <li><a href="data_penggajian_operator.php">Gaji Pegawai</a></li>
            <li class="dropdown">
